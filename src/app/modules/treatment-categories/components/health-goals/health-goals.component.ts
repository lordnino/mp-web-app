...
export class HealthGoalsComponent implements OnInit {
    ...
    loading = false;
    healthGoalsMeta: PaginationMeta;
    params = {
        page: 1,
        count: 10,
        per_page: 10,
    ...
    getAllHealthGoals(params: any = {}) {
        ...
        this.loading = true;
        this.service.getAllHealthGoals(queryParams).subscribe({
            next: (res: any) => {
                this.healthGoals = res.data;
                this.healthGoalsMeta = res.meta;
                console.log('Health Goals:', this.healthGoals);
                console.log('Health Goals Meta:', this.healthGoalsMeta);
                this.loading = false;
            },
