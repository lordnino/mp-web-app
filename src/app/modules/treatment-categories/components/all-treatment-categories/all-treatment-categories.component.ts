...
@Component({
    selector: 'app-all-treatment-categories',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule,
    ...
    templateUrl: './all-treatment-categories.component.html',
    styleUrls: ['./all-treatment-categories.component.scss']
})
export class AllTreatmentCategoriesComponent implements OnInit {
    ...
    getCategories(params: any = {}) {
        ...
        this.service.getAll(queryParams).subscribe({
            next: (res: any) => {
                ...
                this.categoriesMeta = res.meta;
                console.log('Categories:', this.categories);
                console.log('Categories Meta:', this.categoriesMeta);
                this.loading = false;
            },
